...
import 'package:nifti_locapp/components/swap_modal.dart';
...
// ? PincodeExchange == widget to display and capture user's unique pin

// * ---------------- * (STATEFUL WIDGET) CLASS PincodeExchange (STATEFUL WIDGET) * ---------------- *
class PincodeExchange extends StatefulWidget {
  // ? Required variables to be passed
  const PincodeExchange({
    Key? key,
  ...
  @override
  State<PincodeExchange> createState() => _PincodeExchangeState();
}
// * ---------------- * END OF (STATE) CLASS PincodeExchange (STATE) * ---------------- *

// * ---------------- * (STATE) CLASS _PincodeExchangeState (STATE) * ---------------- *
class _PincodeExchangeState extends State<PincodeExchange> {
  ...
  getMsgToken() async {
    ...
    return token = fcmToken.toString();
  }
            ...
            children: <Widget>[
              ...
              const Text("Add Connection",
                  style: TextStyle(
                      ...
                      fontSize: 20,
                      fontWeight: FontWeight.w900,
                      color: Color.fromRGBO(160, 213, 25, 1))),
              const Text('Tell them your code & enter theirs!',
                  style: TextStyle(
                      letterSpacing: 0.8,
                      fontSize: 14,
                      fontWeight: FontWeight.w500,
                      color: Color.fromRGBO(105, 171, 34, 1))),
              const SizedBox(
                height: 25,
              ),
...
// * ---------------- * END OF (STATE) CLASS _PincodeExchangeState (STATE) * ---------------- *